  ...
  <body>
    <div class="main-top" id="home">
      ...
      <div class="headder-top">
        ...
        <nav >
          <div id="logo">
            <h1><a href="index.php">Dish Delights</a></h1>
          </div>
          ...
          <ul class="menu mt-2">
            ...
            <li class="mx-lg-3 mx-md-2 my-md-0 my-1">
              ...
              <ul>
                ...
                <li><a href="my_orders.php" class="drop-text">my orders</a></li>
              </ul>
            </li>
      ...
      <div class="main-banner">
        <div class="container-fluid">
          <div class="style-banner ">
            <h4>A Tasty & delicious</h4>
            <h4>Dish on your Plate</h4>
      ...
      <div class="container-fluid pb-lg-5 pb-md-4 pb-sm-4 pb-3">
        <div class="row">
          <div class="col-lg-3 col-md-3 col-sm-6 about-fashion-one">
            <img src="images/vvvvvv.jpeg" alt="news image" class="img-fluid">
          </div>
          <div class="col-lg-3 col-md-3 col-sm-6 about-fashion-one mt-lg-5 mt-md-4 mt-sm-0">
            <img src="images/bur.jpeg" alt="news image" class="img-fluid" style="height: 150px; width: 150px;">
          </div>
          <div class="col-lg-3 col-md-3 col-sm-6 about-fashion-one pt-lg-4 mt-lg-5 mt-md-4 mt-sm-3">
            <img src="images/chi.jpeg" alt="news image" class="img-fluid">
          </div>
          <div class="col-lg-3 col-md-3 col-sm-6 about-fashion-one">
            <img src="images/new.jpeg" alt="news image" class="img-fluid">
          </div>
        </div>
    ...
    <section class="menu-order py-lg-4 py-md-3 py-sm-3 py-3" id="menu-order">
      <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
        <h6 class="text-center top-title mb-2">Yummy Orders</h6>
        ...
        <?php
          ...
          <div class="col-lg-3 col-md-6">
            ...
            <h4><?php echo $row["food_variety"];?></h4>
            <h4><?php echo $row["food_price"];?></h4>
            <h4> <img src="<?php echo "admin/images-1/".$row["food_image"];?>"style=" width:200px;height:200px";></h4>
            
            <a href="order.php? var=<?php echo $row["reg_no"];?>">Order Now</a>
          </div>
          ...
          <div class="col-lg-4 col-md-4 table-tab-table">
            <div class="table-wthree-price">
              ...
              <div class="view-buttn text-center pt-lg-4 pt-3">
                <a href="contact.html" class="btn ">Book Here</a>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-4 table-tab-table">
      ...
      <div class="container py-lg-4 py-md-4 py-sm-3 py-3">
        <div class="row">
          <div class="col-lg-3 col-md-6 col-sm-6 footer-bottom-txt">
            <h2><a href="index.html">Dish Delights</a></h2>
          ...
          <div class="col-lg-3 col-md-6 col-sm-6 footer-bottom-txt">
            ...
            <div class="mt-3 footer-top">
              ...
              <p class="pt-2"> <span> Phone</span> :+91 9442360211</p>
              <p class="pt-2"><span>Email</span>   :<a href="mailto:info@example.com">dish123@gmail.com</a> 
              </p>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-sm-6 footer-bottom-txt">
    ...
    <div class="footer-copy-write py-lg-3 py-md-2 py-sm-3 py-2">
      <div class="container pb-lg-3 pb-2">
        <div class="bottem-txt-footer text-center pt-md-4 pt-3">
          <p> 
            © 2024 Dish Delights. All Rights Reserved | Design by <a href="http://www.W3Layouts.com" target="_blank">Sona</a>
          </p>
        </div>
        <!-- move icon -->
