 ...
 <div class="panel panel-default">
    ...
    <div>
      <table class="table" ui-jq="footable" ui-options='{
        ...
        $res=$con->query("SELECT * from `users` JOIN `order`  ON users.user=order.user_id;");
        $count=$res->num_rows;
       $counter = 0;
       {
        ...
        ?>
                ...
                <thead>
                    <tr>
                        ...
                        <th>FOOD NAME</th>
                        <th data-breakpoints="xs">FOOD VARIETY</th>
                        <th>FOOD PRICE</th>
                        <th>QUANTITY</th>
                ...
                if($count>0)
                {
                    while($row=$res->fetch_assoc())
                    {
                        ...
                        <td><?php echo ++$counter; ?></td>
                            ...
                            <td>
    <a href="approve.php?set=<?php echo $row['id_o']; ?>" class="btn btn-primary">
        <?php
        if ($row['Status'] == 1) {
            echo "approved";
        } else {
...
<td>
    <a href="reject.php?get=<?php echo $row['id_o']; ?>" class="btn btn-primary">
        <?php
        if ($row['Status'] == 2) {
            echo "rejected";
        } else {
