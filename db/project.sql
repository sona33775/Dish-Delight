...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 18, 2025 at 06:44 AM
...
CREATE TABLE `food` (
  ...
  `food_variety` varchar(100) NOT NULL,
...
INSERT INTO `food` (`reg_no`, `food_name`, `food_variety`, `food_price`, `food_image`) VALUES
(52, 'biryani', 'chicken biryani', '250', 'chicken biryani.jpeg'),
(57, 'chicken 65', 'chilli chicken', '180', 'chilli chicken.jpeg'),
(58, 'pizza', 'cheese pizza', '150', 'pizza.jpeg'),
(59, 'burger', 'veg burger', '170', 'burger.jpeg'),
(60, 'llllllllll', 'chilli chicken', '$170', 'a2.jpg');
...
(1, 'sona33775@gmail.com', '9442360211');
...
INSERT INTO `order` (`id_o`, `food_name`, `food_variety`, `food_price`, `food_quantity`, `total_price`, `user_id`, `Status`) VALUES
(30, 'pizza', 'cheese pizza', '150', '3', '450.00', '23', 1),
(31, 'burger', 'veg burger', '170', '5', '850.00', '26', 1),
(32, 'chicken 65', 'chilli chicken', '180', '3', '540.00', '26', 2),
(33, 'biryani', 'chicken biryani', '250', '1', '250.00', '26', 2),
(34, 'chicken 65', 'chilli chicken', '180', '3', '540.00', '23', 1),
(35, 'biryani', 'chicken biryani', '250', '8', '2000.00', '23', 0),
(36, 'chicken 65', 'chilli chicken', '180', '8', '1440.00', '23', 0),
(37, 'pizza', 'cheese pizza', '150', '8', '1200.00', '27', 0),
(38, 'chicken 65', 'chilli chicken', '180', '2', '360.00', '27', 1),
(39, 'burger', 'veg burger', '170', '5', '850.00', '27', 2),
(40, 'llllllllll', 'chilli chicken', '$170', '2', '0.00', '27', 0);
...
INSERT INTO `users` (`user`, `uname`, `email`, `password`, `phone_number`, `country`, `state`) VALUES
(22, 'jisoo', 'jisoo0987@gmail.com', '09876', '1234567890', '17', '334'),
(23, 'Fairin Sona W', 'sona33775@gmail.com', '9442360211', '9442360211', '101', '35'),
(24, 'lalisa', 'lalisa0987@gmail.com', '00000', '9487664544', '44', '735'),
(25, 'rosie', 'rosie0987@gmail.com', '9877777777', '1234567890', '59', '967'),
(26, 'georrcini', 'geo123@gmail.com', '12345', '6385484853', '51', '842'),
(27, 'ammu', 'ammu123@gmail.com', '123', '098654', '19', '409');
...
--
ALTER TABLE `food`
  MODIFY `reg_no` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
...
--
ALTER TABLE `loginnn`
  MODIFY `id_no` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `order`
--
ALTER TABLE `order`
  MODIFY `id_o` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
...
--
ALTER TABLE `users`
  MODIFY `user` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
COMMIT;
