...
<html lang="zxx">
  <head>
    <title>Sapid a Restaurant Category Bootstrap Responsive web Template|about :: w3layouts</title>
    <!--meta tags -->
    <meta charset="UTF-8">
  ...
  <body>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 text-center about-two-grids">
            ...
            <div class="view-buttn mt-lg-5 mt-md-4 mt-3">
              <a href="contact.html" class=" scroll">Book Here</a>
            </div>
          </div>
          <div class="col-lg-4 about-imgs-txt">
    ...
    <!--//footer -->
    <!-- footer-copy-write -->
    <div class="footer-copy-write py-lg-3 py-md-3 py-2 ">
