  ...
  <body>
    ...
    <section class="menu-order py-lg-4 py-md-3 py-sm-3 py-3" id="menu-order">
      <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
        <h6 class="text-center top-title mb-2">Tasty Orders</h6>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-4">
            <div class="wls-hours-list">
              <ul>
                <li class="d-flex">Pasta<span class="time ml-auto"> $30</span></li>
          ...
          <div class="col-lg-3 col-md-6 col-sm-6 footer-bottom-txt">
            ...
            <div class="mt-3 footer-hours-list">
              <ul>
                ...
                <li class="d-flex">Sunday   <span class="time-footer ml-auto">13:00-18:30</span></li>
              </ul>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-sm-6 footer-bottom-txt">
